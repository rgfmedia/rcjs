    ...
    <input type="hidden" name="getDate" value="<?php echo $_GET['date']; ?>">
        <div class="modal-body">
            <?php foreach ($result as $key => $value): ?>
                ...
                <div class="form-group">
                    <input class="form-control" type="text" placeholder="Number of Heads" name="numheads" value="<?php echo ($value['Num_Heads']==0)?'':$value['Num_Heads']; ?>" >
                </div>
                <div class="form-group">
                    <input class="form-control" type="text" placeholder="Kilos" name="kilo" value="<?php echo ($value['Kg']==0)?'':$value['Kg']; ?>" >
                </div>
                <div class="form-group">
                    <input class="form-control numberformat" type="text" placeholder="Price" name="price" value="<?php echo ($value['Price']==0)?'':number_format($value['Price']); ?>" >
                </div>
            <?php endforeach; ?>
        </div>
