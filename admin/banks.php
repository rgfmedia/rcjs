        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <?php if (!isset($_GET['date'])): ?>
               <button class="btn btn-primary btn-sm btn-icon-split" data-toggle="modal" data-target="#newbank">
...
$sql = "SELECT * FROM banks where IO='in'";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
        while($row = mysqli_fetch_array($result)){
            ...
            echo "<tr>";
                ?>
                <td class='<?php if($row['Status']=="Okay"){echo "success";} else{echo "danger";}; ?>'> <?php echo  $row['Date']; ?></td>
               ...
               <?php
                ...
                echo "<td>" ?>
                <center>
                <button class="btn btn-primary btn-sm" data-namekey="<?php  echo  $row["BNo"]; ?>" data-toggle="modal" data-target="#bankModalEdit">
                    <span class="icon ">
...
<div class="modal fade" id="newbank" tabindex="-1" role="dialog">
    ...
    <div class="form-group">
      ...
      <label class="radio-inline"><input type="radio" value="Declined" name="status" required>Declined</label> 
            ...
            <div class="modal-footer">
                <div class="my-2"></div>
              <button type="submit" name="newbank" class="btn btn-primary btn-sm btn-icon-split">
                  <span class="icon text-white-50">
